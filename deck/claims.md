...
| 24 | Hailo-10H pose throughput (published) | yolov8m_pose 79.2 FPS batch 1, 129 FPS batch 8, 640×640, hardware AP 62.1; host Intel i5-9400; compiled HEF, accelerator throughput (excludes camera decode and host post-processing). Our own UGen300 number waits for the finalist unit — Wayne is not buying one before Stage I (2026-09-17) | 🟢 | Hailo Model Zoo v5.4.0 docs/public_models/HAILO10H/HAILO10H_pose_estimation.rst, fetched 2026-09-17 | R24 | 12 |
...
| 48 | USB link speed matters on UGen300 | a UGen300 user's `hailortcli benchmark` throughput "almost doubled" and "matched the benchmark" after moving from a 5 Gbps link to 10 Gbps (official C-to-C cable) | 🟡 | Hailo Community thread 19320, posts 2026-05-19 to 2026-06-02 (vendor staff replied); exact FPS figures in the thread summary were inconsistent, so only the qualitative finding is on the slide | R25 | 12 |
